...
def data_load_syn_low(args, n_samples, batch_size, cuda, device):
    ...
    data = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data/Syn_{n_samples}_{treatment}_{response}/Syn_train_{nodep}_{nointer}_{args.true_effect}.csv')
    ...
    data_test = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data/Syn_{n_samples}_{treatment}_{response}/Syn_test_{nodep}_{nointer}_{args.true_effect}.csv')
...
def data_load_syn_high(args, n_samples, batch_size, cuda, device):
    ...
    data = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data/Syn_highdim_{n_samples}_{treatment}_{response}/Syn_train_highdim_d2dim100_dimc50_{args.true_effect}.csv')
    # data = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data_U1/Syn_highdim_{n_samples}_{treatment}_{response}/Syn_train_highdim_d2dim100_dimc50_{args.true_effect}.csv')
    ...
    # data_test = pd.read_csv(f' /home/jungsoo/IV_rep/Dataload/Data/Syn_highdim_{n_samples}_{treatment}_{response}/Syn_test_highdim_d2dim100_dimc50_{args.true_effect}.csv')
    data_test = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data/Syn_highdim_{n_samples}_b_{response}/Syn_test_highdim_d2dim100_dimc50_3.csv')
    # data_test = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data_U1/Syn_highdim_{n_samples}_b_{response}/Syn_test_highdim_d2dim100_dimc50_3.csv')
    # '/home/jungsoo/IV_rep/Dataload/Data/Syn_highdim_5000_b_linear/Syn_test_highdim_d2dim100_dimc50_3.csv'
...
def data_load_syn_baseline(args, n_samples, batch_size, cuda, device):
    ...
    # data = pd.read_csv(f'./Dataload/Data/Syn_{n_samples}_{treatment}_{response}/Syn_train_{nodep}_{nointer}_{args.true_effect}.csv')
    data = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data/Syn_DVAECIV_{n_samples}/Syn_DVAECIV_train{n_samples}_{treatment}_{args.true_effect}.csv')
    ...
    ### test set ### 
    # data_test = pd.read_csv(f'./Dataload/Data/Syn_{n_samples}_{treatment}_{response}/Syn_test_{nodep}_{nointer}_{args.true_effect}.csv')
    data_test = pd.read_csv(f'/home/jungsoo/IV_rep/Dataload/Data/Syn_DVAECIV_{n_samples}/Syn_DVAECIV_train{n_samples}_{treatment}_{args.true_effect}.csv')
...
def data_load_real(args, batch_size, cuda, device, target='black'):
    if args.treatment == 'con':
        full_data = pd.io.stata.read_stata('/home/jungsoo/IV_rep/Dataload/main_data_all.dta')
        ...
        data = pd.io.stata.read_stata('/home/kwonho/IV_rep/Dataload/401ksubs.dta')
